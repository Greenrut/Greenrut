...
const fallbackProducts = [
  ...
  {
    id: "fallback-4",
    name: "Green Rut Formula",
    phase: "concluded",
    image: bannerImage,
  },
  {
    id: "fallback-5",
    name: "Future Wellness Blend",
    phase: "future",
    image: heroImage,
  },
];
...
const researchAreaDetails = {
  "Cancer Research": {
    ...
    subtitle:
      "Investigation of anti-proliferative and apoptotic herbal mechanisms.",
    impact:
      "Focuses on identifying bioactive compounds that selectively induce apoptosis in oncogenic cell lines while maintaining normal cell viability. Investigations center on regulating cell cycle progression and modulating signaling pathways.",
    toxicology:
      "Rigorous in-vitro cytotoxicity profiling across multiple healthy human cell lines to establish high selectivity indices and ensure zero toxic off-target accumulation.",
    bioavailability:
      "Studies on molecular formulation to enhance the oral absorption of hydrophobic compounds like polyphenols and terpenoids using natural lecithin-based carrier systems.",
    methodology:
      "Iterative screening starting with high-throughput in-vitro assays, transitioning to in-vivo validation models, and culminating in standardized cohort observational trials.",
  },
  "Sexual & Reproductive Health (Fibroid, PCOS, Fertility)": {
    title: "Sexual & Reproductive Health (Fibroid, PCOS, Fertility)",
    subtitle:
      "Hormonal balancing, uterine tissue optimization, and fertility support.",
    impact:
      "Dedicated to investigating non-invasive herbal interventions for uterine contractility, managing uterine fibroid size reduction, mitigating PCOS symptoms via endocrine pathway balancing, and optimizing follicular development.",
    toxicology:
      "Comprehensive reproductive and developmental toxicology assessments to guarantee absolute safety during gestation and lactation cycles.",
    bioavailability:
      "Standardization of phytosterols and saponins to achieve stable plasma concentrations and long-acting biological response profiles.",
    methodology:
      "Clinical evaluation using double-blind placebo-controlled studies, endocrinology profiling, and sonographic monitoring of uterine tissue structure over 3-6 month intervals.",
  },
  "Heart Health": {
    title: "Heart Health",
    subtitle:
      "Cardioprotective flavonoids, blood pressure regulation, and vascular support.",
    impact:
      "Investigates compounds that support endothelial nitric oxide synthesis, reducing oxidative stress in vascular tissues and promoting arterial elasticity to maintain healthy blood pressure levels.",
    toxicology:
      "Acute and chronic cardiac safety evaluations, specifically monitoring ECG and cardiac biomarker indicators in preclinical models to verify zero cardiotoxicity.",
    bioavailability:
      "Optimization of flavonoid and glycoside absorption through natural synergists that prevent premature hepatic metabolism.",
    methodology:
      "In-vitro endothelial cell assays, in-vivo blood pressure telemetry, and human clinical trials evaluating lipid profile balance and pulse wave velocity.",
  },
  "Digestive & Gut Health": {
    title: "Digestive & Gut Health",
    subtitle:
      "Prebiotic modulation, intestinal barrier support, and mucosal protection.",
    impact:
      "Studies the role of herbal mucilages and bitter glycosides in strengthening the mucosal barrier, balancing gut microbiota composition, and alleviating symptoms of gut wall inflammation.",
    toxicology:
      "Extensive gut lining safety and histology reviews in long-term safety studies to confirm zero irritancy or disruption of intestinal tight junctions.",
    bioavailability:
      "Targeted delivery mechanisms ensuring active compounds remain stable in the gastric environment to be released in specific areas of the colon.",
    methodology:
      "Microbiome sequencing, in-vitro gut wall simulation models, and clinical research monitoring gastrointestinal symptoms and inflammatory markers.",
  },
  "Eyes & Brain Health": {
    title: "Eyes & Brain Health",
    subtitle:
      "Neuroprotection, blood-brain barrier permeability, and retinal support.",
    impact:
      "Focuses on neuroprotective alkaloids that cross the blood-brain barrier to reduce neuroinflammation, support cognitive function, and retinal pigments that prevent macular degeneration.",
    toxicology:
      "Targeted neurotoxicity screenings and ocular cell viability tests verifying zero accumulation in brain and ocular tissues.",
    bioavailability:
      "Studies on structural modifications to cross the blood-brain barrier effectively and enhance neuro-absorption.",
    methodology:
      "In-vitro neuron and microglial assays, retinal cell culture evaluations, and clinical cognitive performance trials in healthy volunteers.",
  },
  "Bones & Joint Health": {
    title: "Bones & Joint Health",
    subtitle:
      "Chondroprotective glycosides and bone tissue osteoclast-osteoblast balance.",
    impact:
      "Investigates anti-inflammatory botanical extracts that inhibit matrix metalloproteinases, preventing cartilage degradation and supporting bone mineral density and joint flexibility.",
    toxicology:
      "Comprehensive bone marrow and bone tissue safety screens confirming zero adverse effects on mineral metabolism or endocrine pathways.",
    bioavailability:
      "Standardization of bio-active minerals and glycosides to optimize assimilation into joint tissue and articular cartilage.",
    methodology:
      "Chondrocyte cell studies, in-vivo models of osteoarthritis progression, and clinical trials monitoring joint movement pain and bone density markers.",
  },
};
...
const clinicalStudies = [
  {
    ...
    outcome:
      "Supports the zero toxicology commitment through structured safety review.",
    summary:
      "A research summary format for documenting methods, safety observations, and product-specific findings.",
  },
  {
    title: "Bioactive Constituents and Therapeutic Potential",
    outcome:
      "Maps major constituents to traditional use and modern therapeutic relevance.",
    summary:
      "Designed to hold summaries from TLC-MS, phytochemical screening, assays, and partner-lab reports.",
  },
  {
    title: "Formulation Potency and Quality Assurance",
    outcome:
      "Documents standardization, consistency, and product development evidence.",
    summary:
      "A publication slot for clinical notes, product validation, and controlled study summaries.",
  },
];
    ...
    >
      <article className="w-full text-left">
        ...
        <div className="px-1 pt-3">
          <h3 className="text-[13px] font-normal leading-5 text-[#5d5a56]">
            {product.name}
          </h3>
          <p className="mt-1 text-[11px] font-semibold leading-4 text-[#63ac18]">
            View Research
          </p>
        </div>
      </article>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-[10px] uppercase tracking-[0.16em] text-[#73aa23] font-semibold">
          Greenrut Research Area
        </p>
        <h3 className="mt-1 font-serif text-[22px] text-[#2e2a26] leading-tight font-bold">
          {details.title}
        </h3>
        <p className="mt-2 text-[12px] italic text-[#63ac18]">
          {details.subtitle}
        </p>
        ...
        <div className="mt-6 space-y-4 max-h-[360px] overflow-y-auto pr-2 text-[12px] leading-6 text-[#5a544c]">
          <div className="border-l-2 border-[#73aa23] pl-3 py-0.5">
            <strong className="block text-[#2e2a26] font-semibold text-[13px]">
              Therapeutic Impact & Applications
            </strong>
...
export function ResearchPage({ onNavigate }) {
  ...
  const researchItems = useMemo(() => {
    ...
    const normalized = source.map((product, index) => ({
      product,
      stage: inferStage(product, index, source.length),
    }));
    ...
    if (sortBy === "name-desc")
      sorted.sort((a, b) =>
        String(b.product.title || b.product.name || "").localeCompare(
          String(a.product.title || a.product.name || ""),
        ),
      );
  ...
  return (
    <section className="page-shell py-6 xs:py-8 lg:py-10">
        ...
        >
          <div className="max-w-[520px] text-white">
            ...
            <h1 className="mt-2 font-serif text-[30px] leading-none xs:text-[34px]">
              Science-Backed Herbal Innovation
            </h1>
            <p className="mt-3 text-[12px] leading-6 text-white/80 xs:text-[13px]">
              Unveiling the rigorous research, quality assurance, and zero
              toxicology commitment behind every Greenrut product.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="mx-auto mb-5 w-full max-w-[820px] border border-[#efefef] bg-white p-5">
        ...
        <h2 className="mt-2 font-serif text-[22px] text-[#2e2a26]">
          Key Research Areas
        </h2>
        <p className="text-[11px] text-[#8e8a84] mt-1">
          Click on any research area to explore detailed therapeutic impacts,
          toxicology, bioavailability, and methodologies.
        </p>
          ...
          <table className="w-full min-w-[620px] border-collapse text-left text-[12px] text-[#5a544c]">
            ...
            <tbody>
              {clinicalStudies.map((study) => (
                ...
                >
                  <td className="px-3 py-3 font-semibold text-[#2e2a26]">
                    {study.title}
                  </td>
        ...
        <div className="mx-auto mb-5 w-full max-w-[820px] border border-[#efefef] bg-white p-5">
          ...
          <p className="mt-3 text-[13px] leading-6 text-[#4a453f]">
            {selectedItem.content ||
              ...
              "No further details have been published for this research item yet."}
          </p>
          <button
            type="button"
            className="mt-4 text-[11px] font-semibold text-[#1f1c19] underline"
          ...
          <div className="min-w-0">
            <div className="flex flex-wrap gap-2 items-center border border-[#efefef] bg-white px-3 py-2.5">
              <div className="flex items-center gap-2">
                <button
                  type="button"
                  className="grid h-6 w-6 place-items-center rounded hover:bg-[#f3f8ec]"
              ...
              <p className="ml-3 hidden text-[11px] leading-none text-[#59534b] sm:block">
              ...
              <div className="ml-auto flex items-center gap-3 text-[11px] text-[#5a544c]">
                <label className="flex items-center gap-1.5">
                  ...
                  <select
                    value="grid"
                    readOnly
                    className="h-[26px] w-[56px] border border-[#ece8df] bg-white px-1.5 text-[11px] text-[#5a544c]"
                  >
                ...
                <label className="flex items-center gap-1.5">
                  ...
                  <select
                    ...
                    className="h-[26px] w-[124px] border border-[#ece8df] bg-white px-1.5 text-[11px] text-[#5a544c]"
                  >
